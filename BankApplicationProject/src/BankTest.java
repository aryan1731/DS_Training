...
//		BankApplicationForm bankAppForm3 = new BankApplicationForm();
		...
		bankAppForm2.setAccountType("Savings");
...
//		BankAccount bankAcc3 = bank.applyForABankAccount(bankAppForm3); //passing object here 
		...
		BankAccount bankAcc1 = bank.applyForJointAccout(bankAppForm2,bankAppForm1);
...
class Bank
{
	...
	BankAccount applyForJointAccout(BankApplicationForm bankAppFormRef1, BankApplicationForm bankAppFormRef2) {
		BankAccount bankAccObj = new BankAccount();
		System.out.println("recieved both the application form" +bankAppFormRef1.getApplicantName()+ " "+bankAppFormRef2.getApplicantName());
		System.out.println("Creating bank account");
		...
		bankAccObj.setIfscCode("BOB000000345");
		bankAccObj.setAccountBalance(5000);
